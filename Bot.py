...
async def check_subscriptions(callback: CallbackQuery):
    ...
    if not not_subscribed:
        await callback.message.answer("Принято. Ваша заявка будет обработана в течении 24х часов. Перед началом работы - прочтите инструкцию по эксплуатации бота, найти её можно в описании.")
    else:
